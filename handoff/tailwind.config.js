// tailwind.config.js
// REPLACE your existing tailwind config with this (or merge the `theme.extend` block).
// After this, classes like `bg-bg-primary`, `text-accent`, `font-display` will work.
